...
class Route
{
    ...
    protected function _run($method, $controller, $action, $params = array())
    {
        ...
        if (!is_file($controller_file)) {
            throw new Exception\NotFound('The Controller '. $controller .' is not exists');
        }
        ...
        if (!class_exists($controller_class_name)) {
            throw new Exception\NotFound('The Controller Class '. $controller_class_name .' is invalid');
        }
        ...
        if (!method_exists($controller_class, $action_method)) {
            throw new Exception\NotFound('The Action '. $action .' is invalid');
        }
        if (empty($params)) {
